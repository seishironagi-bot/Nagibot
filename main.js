...
let text = [`${lenguaje.Bio.text} ${Object.keys(global.db.data.users).length} ${lenguaje.Bio.text2} ${latensi.toFixed(4)} 🚀`, `${lenguaje.Bio.text3} ${uptime}\n\n${lenguaje.Bio.text4}`, `${lenguaje.Bio.text5}`, `👑 Nagi-Bot uso: ${conn.public ? 'Publico' : 'Privado'} | ${lenguaje.Bio.text6} ${uptime} | ${lenguaje.Bio.text7} ${Object.keys(global.db.data.users).length}`];
